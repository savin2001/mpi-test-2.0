                ...
                <div class="selection">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 padding-con">
                                <div class="card" style="width: 12rem;">
                                    <img src="../media/about7.jpg" class="card-img-top" alt="...">
                                    <div class="card-body">
                                      <h5 class="card-title">Card title</h5>
                                      <p class="card-text"><small> Some quick example text to build on the card title.</small></p>
                                    </div>
                                  </div>
                            </div>
                            <div class="col-lg-4 col-md-6  padding-con">
                    ...
                    <!-- <div id="videos" class="card-body">
                        ...
                        <h3 class="text-dark margin-center ml-auto">
                            <p class="">Post a new video <a href=""><i class="fa fa-plus-circle" aria-hidden="true"></i></a> </p>
                        ...
                        <div class="card mb-3">
                            <iframe class="card-img-top" width="100%" height="540px" src="https://www.youtube.com/embed/KvHaN4gvxL4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <div class="card-body">
                              <h5 class="card-title">Card title</h5>
