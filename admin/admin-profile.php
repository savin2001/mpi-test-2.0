...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
  ...
  //$sql="SELECT password FROM users WHERE user_id = 'htmlspecialchars($_SESSION["user_id"])'";
}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="collapse navbar-collapse " id="navbarNavAltMarkup">
                  <div class="navbar-nav ml-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="admin.php#dashboard">Dashboard <span class="sr-only">(current)</span></a>
                      </li>
                     <li class="nav-item ">
                        <a class="nav-link" href="admin.php#users">Users</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="admin.php#news">News</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="admin.php#docs">Documents</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="admin.php#photos">Photos</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="admin.php#videos">Videos</a>
                      </li>
                ...
                <div class="col-lg-9 about bg-white">
                  ...
                  if (mysqli_num_rows($result)) {
                    ...
                    echo '
                      ...
                      <br>
                      <div class="about p-4">
                        <a href="reset-password.php" class="btn btn-outline-warning btn-large">Change your password</a>
                      </div>
                  ';
                  ?>
                </div>
