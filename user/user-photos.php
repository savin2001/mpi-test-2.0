        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-lg-7 about bg-white">
                    <ul class="list-unstyled">
                        ...
                        <h3 class="ml-auto">
                            <p class="text-primary">My photos </p>
                ...
                <div class="col-lg-2 about ">
                  <div class="p-4 stick">
                    <h4 class="font-italic">Recent photos</h4>
                  ...
                  while ($row = mysqli_fetch_array($results)) {
                    echo '
                          <li><a href="../admin/'.$row['photo_path'] .'">'.$row['photo_date'] .'</a></li>
            ...
            <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
              ...
              <div class="modal-content">
                  ...
                  <input type="submit" value="Post photo" name="submit" class="btn btn-primary" required>
                          </form>
                    </div>
                  </div>
              </div>
          ...
          <div class="modal fade" id="exampleModalLong1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                  <form class="" action="user-delete-media.php" method="post">
