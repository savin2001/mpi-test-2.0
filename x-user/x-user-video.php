    ...
    <div class="container-fluid bg-light">
        <div class="container">
            <div class="row ">
                ...
                <div class=" p-4 col-lg-7 about bg-white">
                  ...
                  <div class="modal-body">
                      <form action="../admin/video-upload.php" method="post" enctype="multipart/form-data">
                        <input type="text" name="vid_name" class="form-control" placeholder="Video name" required="" autofocus="">
                              <br>
                        <input type="text" name="vid_url" class="form-control" placeholder="Paste embeded code" required="" autofocus="">
                              <br>
